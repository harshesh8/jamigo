      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        {state.tracks.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-6">
            <div className="w-24 h-24 bg-bg-slate rounded-full flex items-center justify-center mb-4 shadow-lg shadow-primary/20 animate-pulse overflow-hidden p-4">
            ...
            <label className="cursor-pointer bg-primary text-bg-ink font-bold py-4 px-8 rounded-2xl shadow-lg hover:scale-105 transition-transform active:scale-95 flex items-center gap-2">
              <Upload size={20} />
