  ...
  return (
    <header className="h-16 px-4 flex items-center justify-between bg-bg-graphite border-b border-bg-slate shrink-0 z-20">
      ...
      <div className="flex items-center gap-3">
        ...
        <button 
          onClick={() => exportMix()}
          className="bg-primary text-bg-ink font-bold px-4 py-2 rounded-xl flex items-center gap-2 text-sm hover:brightness-110 active:scale-95 transition-all shadow-lg shadow-primary/20"
        >
          <Download size={16} />
