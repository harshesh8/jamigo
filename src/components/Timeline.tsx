      ...
      >
        ...
        <div className="sticky top-0 z-40 flex h-8 bg-bg-charcoal border-b border-bg-slate shrink-0">
            ...
            >
                ...
                <div 
                   className="absolute top-0 w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[8px] border-t-accent-mint transform -translate-x-1/2 transition-transform duration-75"
        ...
        <div className="flex-1 relative">
             ...
             <div 
                className="absolute top-0 bottom-0 w-[2px] bg-accent-mint z-30 pointer-events-none transition-transform duration-75"
                style={{ 
             ...
             <div className="absolute top-0 bottom-0 left-24 right-0 pointer-events-none overflow-visible">
                <div 
                    className="absolute top-0 bottom-0 w-[2px] bg-accent-mint shadow-[0_0_10px_rgba(120,251,166,0.5)]"
                    style={{ left: state.currentTime * state.zoom }}
                ></div>
             </div>
