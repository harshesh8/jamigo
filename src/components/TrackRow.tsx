...
export const TrackRow: React.FC<TrackRowProps> = ({ track, height = 96 }) => {
  ...
  return (
    ...
    >
      {/* Sticky Header */}
      <div className="sticky left-0 z-30 w-24 bg-bg-graphite border-r border-bg-slate flex flex-col justify-center items-center px-1 gap-1 shadow-md">
         {/* Name brought back */}
         <div className="w-full text-center px-1">
            <div className="text-[10px] font-bold text-text-high truncate leading-tight mb-1" title={track.name}>
                {track.name}
            </div>
         </div>
         
         <div className="w-8 h-1 rounded-full mb-1" style={{ backgroundColor: track.color }}></div>
